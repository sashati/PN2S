...
#include "../cudaLibrary/SynapticData.hpp"
...
void HSC_PerformSimulation::updateBenchmark()
{
...
void HSC_PerformSimulation::syncCpuThreads()
{
    pthread_mutex_lock(sharedData->mutex);
    sharedData->nBarrier++;
    if(sharedData->nBarrier < sharedData->nThreadsCpu)
...
void HSC_PerformSimulation::updateGenSpkStatistics(int *& nNeurons, SynapticData *& synData)
{
	/*--------------------------------------------------------------
...
void HSC_PerformSimulation::generateRandomSpikes( int type, RandomSpikeInfo & randomSpkInfo )
{
...
void HSC_PerformSimulation::addReceivedSpikesToTargetChannelCPU()
{
...
// * Load Model
// *======================================================================================================*/
//int HSC_PerformSimulation::setup(Id seed, double _dt) {
//
//	GpuSimulationControl *gpuSimulation = new GpuSimulationControl(tInfo);
//
//	/**
