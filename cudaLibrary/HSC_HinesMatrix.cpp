...
HSC_HinesMatrix::HSC_HinesMatrix() {
	CM = 1; // uF/cm2
	RA = 0.1; // kOhm*cm
	RM = 10; // kOhm*cm2
 ...
 *  [ 1 | 2 | 3 ]
 */
void HSC_HinesMatrix::defineNeuronCable() {
	nComp = 5;
...
void HSC_HinesMatrix::defineNeuronSingle() {
	nComp = 1;
	junctions = new int *[nComp];
	for (int i=0; i<nComp; i++) {
		junctions[i] = new int[nComp];
...
void HSC_HinesMatrix::defineNeuronCableSquid() {
	nComp = 1;
	junctions = new int *[nComp];
	for (int i=0; i<nComp; i++) {
		junctions[i] = new int[nComp];
 ...
 */
void HSC_HinesMatrix::defineNeuronTreeN(int nComp, int active) {
...
void HSC_HinesMatrix::initializeFieldsSingle() {
 ...
 */
void HSC_HinesMatrix::createTestMatrix() {
 ...
 */
void HSC_HinesMatrix::upperTriangularizeSingle() {
...
//void HSC_HinesMatrix::findActiveCurrents() {
//
...
void HSC_HinesMatrix::upperTriangularizeAll() {
...
void HSC_HinesMatrix::updateRhs() {
...
void HSC_HinesMatrix::backSubstitute() {
...
void HSC_HinesMatrix::solveMatrix() {
...
void HSC_HinesMatrix::writeVmToFile(FILE *outFile) {

	fprintf(outFile, "%10.2f\t%10.2f\t%10.2f\n", dt * currStep, vmList[nComp-1], vmList[0]);
}

void HSC_HinesMatrix::printMatrix(ftype *list) {
