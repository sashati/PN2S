///////////////////////////////////////////////////////////
//  PN2S_HSolve.cpp
//  Implementation of the Class PN2S_HSolve
//  Created on:      27-Dec-2013 7:57:50 PM
//  Original author: Saeed Shariati
///////////////////////////////////////////////////////////

#include "PN2S_HSolve.h"
#include "solve.h"
...
PN2S_HSolve<T,arch>::PN2S_HSolve()
{
	_hm = 0;
	_hm_dev = 0;
	_rhs = 0;
...
template <typename T, int arch>
hscError PN2S_HSolve<T,arch>::PrepareSolver(vector<PN2SModel<T,arch> > &network, PN2S_NetworkAnalyzer<T,arch> &analyzer)
{
//	cudaError_t success;
	cublasStatus_t stat;
...
template <typename T, int arch>
hscError PN2S_HSolve<T,arch>::Process()
{
	UpdateMatrix();
...
template <typename T, int arch>
hscError PN2S_HSolve<T,arch>::UpdateMatrix()
{
	uint vectorSize = nModel * nComp;
...
template <typename T, int arch>
void PN2S_HSolve<T,arch>::makeHinesMatrix(PN2SModel<T,arch> *model, T * matrix)
{
	/*
...
template class PN2S_HSolve<double, ARCH_SM30>;
